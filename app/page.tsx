...
// (AdSense > Anúncios > Por unidade de anúncio > Criar nova unidade)
const AD_SLOT_HOMEPAGE_BANNER  = "XXXXXXXXXX"; // Leaderboard/Responsivo — entre seções
const AD_SLOT_HOMEPAGE_BOTTOM  = "YYYYYYYYYY"; // Retângulo — acima do footer
// ──────────────────────────────────────────────────────────────────────────────
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 bg-background">
        ...
        {/* ── Anúncio AdSense — Entre Seções ── */}
        <section className="flex justify-center py-6 bg-muted border-y border-border">
          <div className="w-full max-w-6xl px-4 flex justify-center">
            <AdSenseUnit
              slot={AD_SLOT_HOMEPAGE_BANNER}
              format="auto"
        ...
        {/* ── Anúncio AdSense — Acima do Footer ── */}
        <section className="flex justify-center py-6 bg-muted border-t border-border">
          <div className="w-full max-w-6xl px-4 flex justify-center">
            <AdSenseUnit
              slot={AD_SLOT_HOMEPAGE_BOTTOM}
              format="auto"
              style={{ display: "block", width: "100%", minHeight: "90px" }}
            />
          </div>
